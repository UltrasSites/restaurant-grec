...
export const menuPages: MenuPage[] = [
  {
    ...
    items: [
      { el: "Αναψυκτικά 330ml", en: "Soft drinks 330ml", de: "Erfrischungsgetränke 330ml", ru: "Безалкогольные напитки 330мл", ja: "ソフトドリンク 330ml", desc_el: "Coca-Cola, Sprite, Fanta, Soda — δροσερό κουτάκι", desc_en: "Coca-Cola, Sprite, Fanta, Soda — ice-cold can", desc_de: "Coca-Cola, Sprite, Fanta, Soda — eiskalte Dose", desc_ru: "Coca-Cola, Sprite, Fanta, Soda — ледяная баночка", desc_ja: "コカ・コーラ、スプライト、ファンタ、ソーダ — 冷えた缶", price: "1,60€" },
      { el: "Αναψυκτικά 1.5L", en: "Soft drinks 1.5L", de: "Erfrischungsgetränke 1.5L", ru: "Безалкогольные напитки 1.5л", ja: "ソフトドリンク 1.5L", desc_el: "Οικογενειακή φιάλη για μοιρασιά", desc_en: "Family-size bottle to share", desc_de: "Familienflasche zum Teilen", desc_ru: "Семейная бутылка, чтобы поделиться", desc_ja: "シェアできるファミリーサイズ", price: "2,50€" },
