...
const ui: Record<Lang, RestaurantTranslations> = {
  el: {
    ...
    meta_description: 'Αυθεντικά καλαμάκια, γύρος και πίτες στην καρδιά της Τρούμπας Πειραιά. Μπουμπουλίνας 8 & Νοταρά. Δευ–Πέμ 13:00–02:30 · Παρ 13:00–04:00 · Σαβ 20:00–05:00.',
    nav_home: 'Αρχική',
    ...
    card5_desc: 'Η ζωντανή φλόγα, το άρωμα του ψητού. Σχάρα που δουλεύει ακατάπαυστα από τις 13:00.',
    ...
    contact_lead: 'Μπουμπουλίνας 8 & Νοταρά, Πειραιάς. Δευτέρα έως Πέμπτη από τις 13:00, Παρασκευή από τις 13:00, Σάββατο από τις 20:00 (Κυριακή κλειστά). Κάλεσε ή παράγγειλε online.',
  ...
  en: {
    ...
    meta_description: 'Authentic souvlaki, gyros and pita in the heart of Troumpa, Piraeus. Bouboulinas 8 & Notara. Mon–Thu 13:00–02:30 · Fri 13:00–04:00 · Sat 20:00–05:00.',
    nav_home: 'Home',
    ...
    card5_title: 'Charcoal Fire',
    card5_desc: 'Live flame, the scent of char. Our charcoal grill runs non-stop from 13:00 every day (Sat from 20:00).',
    ...
    contact_lead: 'Bouboulinas 8 & Notara, Piraeus. Mon–Thu from 13:00, Fri from 13:00, Sat from 20:00 (Sun closed). Call or order online.',
    contact_email: 'kalamaki.troubas@gmail.com',
    contact_demo: '+30 210 422 2233',
